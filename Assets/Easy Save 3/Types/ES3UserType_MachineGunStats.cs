...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("upgradeLevel", "priceToUse", "ammoCount", "bulletDamage", "attackSpeed", "reloadTime")]
	public class ES3UserType_MachineGunStats : ES3Type
	{
		public static ES3Type Instance = null;

		public ES3UserType_MachineGunStats() : base(typeof(ActiveSkillStats)){ Instance = this; priority = 1;}
	...
	public class ES3UserType_MachineGunStatsArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_MachineGunStatsArray() : base(typeof(ActiveSkillStats[]), ES3UserType_MachineGunStats.Instance)
		{
			Instance = this;
		}
	}
