Shader "BigRig/PBR/Car Paint - Opaque" {
	Properties {
		...
		[ToggleOff] _TriplanarAlbedo ("Triplanar albedo", Float) = 0
		[Toggle(_IS_CUSTOM_SKIN_MATERIAL)] _IsCustomSkinMaterial ("Is custom skin material?", Float) = 0
		_CustomSkinColor ("Custom skin color", Vector) = (1,1,1,1)
